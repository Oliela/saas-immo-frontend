...
export default function VisitsAllList({ visits = [] }: VisitsAllListProps) {

  const [statusFilter, setStatusFilter] = useState("all")
  const [search, setSearch] = useState("")
  // Stocke l'id de la réservation en cours d'action pour gérer le loading par ligne
                  ...
                  <div className="flex-1 min-w-0">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 text-sm text-muted-foreground mt-1">
                          ...
                          <span className="truncate capitalize">
                            {s.bien.propertyType} · {s.agency.name}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4 mt-2 text-sm text-muted-foreground">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        {s.agent ? `${s.agent.prenom} ${s.agent.nom}` : s?.agency?.name}
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      {!(isCompleted || isCancelled) && (
                        <>
                          ...
                          >
                            {isLoading && loadingAction === "reminder"
                          ...
                          <DropdownMenuItem
                            ...
                            onClick={() => handleCancelVisit(reservation)}
                          >
