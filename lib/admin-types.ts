...
export interface ClientDocument {
  id: string
  clientId: string
  type: "cni" | "passeport" | "justificatif_domicile" | "bulletin_salaire" | "contrat_travail" | "autre"
  typeLabel: string
  fileName: string
  fileUrl: string
  fileSize: number
...
export interface Activity {
  id: string
  type: "contract_signed" | "payment_received" | "agency_certified" | "client_registered" | "subscription_renewed" | "invoice_paid"
  title: string
  description: string
  entityId: string
  entityType: "contract" | "payment" | "agency" | "client" | "subscription" | "invoice"
  agencyId?: string
  agencyName?: string
  amount?: number
  createdAt: string
